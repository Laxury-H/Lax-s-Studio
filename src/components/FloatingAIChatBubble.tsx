  ...
  return (
    <div className="fixed bottom-20 right-3 md:bottom-12 md:right-5 z-[120] pointer-events-none">
      ...
      <button
        ...
        className="pointer-events-auto group h-14 w-14 rounded-2xl border border-border bg-radiant backdrop-blur-md text-primary-fg shadow-2xl shadow-black/25 opacity-70 hover:opacity-100 hover:translate-y-[-1px] active:translate-y-0 transition-all duration-300 flex items-center justify-center cursor-pointer"
        title={isOpen ? "Close AI chat" : "Open AI chat"}
      >
        <span className="relative flex h-8 w-8 items-center justify-center rounded-xl bg-primary-fg text-primary shrink-0">
